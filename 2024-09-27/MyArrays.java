public class MyArrays{
  ...
  public static int[] concatArray(int[]ary1,int[]ary2){
    ...
    int index = ary1.length;
    for (int i = 0; i < ary1.length; i++){
      concat[i] = ary1[i];
    }
    for (int n = 0; n < ary2.length; n++){
      concat[index+n] = ary2[n];
    }
    return concat;
  }
  ...
  public static void main(String[] args){
    ...
    int[] nums2 = {-3, -2, -1, 0};
    System.out.println("Expected: [-3, -2, -1, 0], received: " + arrayToString(nums2));
    int[] nums3 = {};
    System.out.println("Expected: [], received: " + arrayToString(nums3));
